package javaProStanislav.lesson16_10052023.streamPractice.flatMapExample2;
...
public class FlatMapExample2 {
    public static void main(String[] args) {
        ...
        Map<String,List<String>> phonesNumbersMap = humans.stream()
                .flatMap(human -> human.getPhones()
                        .stream()
                        .map (phone ->  new AbstractMap.SimpleEntry<>(phone, human.getName()) {}))
